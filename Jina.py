...
headers = {
    ...
    "Authorization": "Bearer jina_eb296e1377f74ffd846c60f519254441EknNG_4XjwYVdhRPJKdqkgpYu6UA"
}
data = {
    "model": "jina-reranker-v2-base-multilingual",
    "query": "开始时间：2024年，银行业务",
    "top_n": 3,
    "documents": [
...
path_file = "G:\下载\8c0zj-5ddsh\p3r68-cdx67\8c0zj-5ddsh.json"
...
str_data = []
for it in a:
    str_data.append(str(it))
data["documents"] = str_data

response = requests.post(url, headers=headers, data=json.dumps(data))

repo = response.json()
print(repo)
print(repo.get("results"))
